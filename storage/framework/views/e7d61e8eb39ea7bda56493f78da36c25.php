<?php $__env->startSection('content'); ?>
    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $berita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <article class="mb-4 pb-3">
            ...
            <h6> By : <a class="text-decoration-none" href="#"><?php echo e($berita->user->name); ?></a> | category : <a class="text-decoration-none" href="/categories/<?php echo e($berita->category->slug); ?>"><?php echo e($berita->category->name); ?></a></h6>
