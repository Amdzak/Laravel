<?php $__env->startSection('content'); ?>
    ...
    <h6> By : <a class="text-decoration-none" href="/authors/<?php echo e($berita->user->username); ?>"><?php echo e($berita->user->name); ?></a> | category : <a href="/categories/<?php echo e($berita->category->slug); ?> " class="text-decoration-none"><?php echo e($berita->category->name); ?></a></h6>
